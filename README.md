...
1. **Delete remaining resources.** _Optional._
   ...
   Delete the managed identity. Note, deleting the Managed Identity does NOT remove role assignments to it. See the steps above for removing role assignments used by this identity.
